...
export const subbrands = [
    {
        ...
        text: [
            ...
            'Это самый большой по объёмам бренд кормов для собак с возможностью привлекать в категорию самых чувствительных к цене потребителей.',
        ]
    },
    {
        ...
        text: [
            ...
            'Мы верим, что лучшая жизнь – это жизнь, которую можно разделить с другом. Поэтому CESAR® помогает создавать больше моментов настоящей дружбы с питомцем.',
        ]
    ...
    },
    {
        ...
        text: [
            ...
            'Роль бренда в портфеле – конвертировать в категорию самых чувствительных к цене потребителей и защищать масштабы бизнеса Mars Pet Nutrition. А еще KITEKAT™ – абсолютный лидер в доступном ценовом сегменте кормов для кошек.',
        ]
    ...
    },
    {
        ...
        text: [
            ...
            'В основе философии бренда – вера, что каждая кошка и собака достойна натурального питания высшего качества.'
        ]
    ...
    },
    {
        ...
        text: [
            ...
            'В основе философии бренда CRAVE™ – природные инстинкты домашних животных, которые те унаследовали от диких предков.'
        ]
    }
]